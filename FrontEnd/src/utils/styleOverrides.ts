 ...
 */
export function applySelectStyleOverrides(): void {
  // 创建样式元素
  ...
  styleEl.innerHTML = `
    ...
    .register-container .el-select-dropdown__item,
    .login-container .el-select-dropdown__item {
    ...
    .register-container .el-popper.is-light.el-select__popper,
    .login-container .el-popper.is-light.el-select__popper {
 ...
 */
export function modifyElementPlusVars(): void {
  // 获取根元素
...
export default function applyAllOverrides(): void {
